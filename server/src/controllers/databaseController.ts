...
// Get collections
export const getCollectionsList = async (_req: Request, res: Response) => {
  try {
...
export const getAllWatchlists = async (_req: Request, res: Response) => {
  try {
...
export const getAllSavedMovies = async (_req: Request, res: Response) => {
  try {
