...
const WatchlistPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen min-w-screen bg-gradient-to-r from-orange-400 to-red-600 p-6">
      ...
      {movies.length === 0 ? (
        <p className="text-center text-white">No movies in this watchlist yet. Add some movies!</p>
      ) : (
        <div>
          <h2 className="text-3xl font-semibold text-black mb-4">Movies in your Watchlist</h2>
          {isListView ? (
